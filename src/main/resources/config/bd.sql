...
CREATE TABLE IF NOT EXISTS fotografia (
    id_fotografia INT AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS propiedad (
    ...
    FOREIGN KEY (id_pais_ubi) REFERENCES pais_ubicacion(id_pais_ubi),
    FOREIGN KEY (id_ciudad_ubi) REFERENCES ciudad_ubicacion(id_ciudad_ubi),
    FOREIGN KEY (id_region_ubi) REFERENCES region_ubicacion(id_region_ubi),
...
INSERT INTO fotografia (fotografia) VALUES (LOAD_FILE('C://User/Escritorio/imagen.jpg'));
...
VALUES (1, 3, 150.00, TRUE, 2, TRUE, FALSE, 'Calle Principal 123', 1, 1, 1, 1, LAST_INSERT_ID(), 6);
